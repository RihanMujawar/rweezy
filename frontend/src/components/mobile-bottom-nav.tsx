...
import { Bike, ClipboardList, Home, ShoppingBasket, User, UtensilsCrossed } from "lucide-react";
...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 px-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] md:hidden">
      <div className="mx-auto grid max-w-md grid-cols-6 rounded-2xl border border-white/25 bg-background/55 p-1.5 shadow-2xl shadow-black/15 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/45">
