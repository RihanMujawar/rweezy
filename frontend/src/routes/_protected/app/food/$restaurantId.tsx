...
import { Plus, Minus, Search, ShoppingCart, UtensilsCrossed } from "lucide-react";
...
function RestaurantPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Link to="/app/food" className="text-sm text-muted-foreground hover:underline">
        ← All restaurants
      </Link>
      ...
      <div className="mt-6 grid gap-3">
        {items.length === 0 ? (
          ...
          <div className="rounded-lg border bg-card p-8 text-center">
            <p className="font-medium">No menu matches</p>
